...
public class Grasp {
	...
	public int[] graspSearch(int x, int y, int mat[][], int semilla, Panel pa, String fich, int ej) {
		int[] solAux;
		int[] mejorSol = new int[x];
		int mejorCoste = 99999999;
		int cosAux;
		int cubre[] = new int[x];
	 ...
	 * @param cubre Array con el numero de territorios a los que cubre cada
	 *              comisaria
	 * @return Devuelve true si faltan territorios sin cubrir, false en caso
	 *         contrario
	 */
	 ...
	 * @param cubreOrdenado Array ordenado de mayor a menor de cuantos territorios
	 *                      son cubiertos por cada comisaria
	 */
	public void eliminaRedundancias(int x, int y, int[] solucion, int[][] matriz, Pair[] cubreOrdenado) {
		int quito;
		int i;
		boolean columnaRedundante;
		boolean sustituible;
		for (int z = 0; z < x - 1; z++) {
